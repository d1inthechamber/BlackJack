...
enum class RoomStyle(val id:String,val title:String,val host:String,val background:Int,val dealer:Int,
    ...
    EGYPT("egypt","Pharaoh’s Palace","The pharaoh",R.drawable.room_egypt,R.drawable.dealer_egypt,R.drawable.back_egypt,Color(0xFFF0CD75),Color(0xFFD0AF52),Color(0xFFFFF6DB)),
    IRON("iron","Ironworks","The factory card sharp",R.drawable.room_iron,R.drawable.dealer_iron,R.drawable.back_iron,Color(0xFFDEAB81),Color(0xFFC39367),Color(0xFFF4EADB)),
    WEST("west","West Coast ’94","The West Coast host",R.drawable.room_west,R.drawable.dealer_west,R.drawable.back_west,Color(0xFFB5D6CD),Color(0xFF86B8AC),Color(0xFFF1F7F5)),
